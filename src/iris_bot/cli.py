...
from iris_bot.commands.governance import (
    ...
    demo_forward_runbook_runtime_command,
    demo_operational_readiness_command,
    diagnose_profile_activation_command,
    demo_serious_validated_gate_command,
    prolonged_serious_demo_gate_command,
    serious_demo_control_gate_command,
    evidence_store_status_cmd,
    ingest_governance_evidence_command,
...
from iris_bot.commands.operations import (
    activate_demo_execution_runtime_command,
    close_demo_forward_series_runtime_command,
    demo_forward_series_status_runtime_command,
    demo_execution_preflight_runtime_command,
    demo_execution_status_runtime_command,
    mt5_check_command,
    reconciliation_drills_command,
    recovery_drills_command,
    restore_safety_drill_command,
    run_demo_execution_runtime_command,
    start_demo_forward_series_runtime_command,
    ...
    validate_model_artifact_runtime_command,
)
from iris_bot.commands.research import (
    audit_exit_lifecycle_command,
    audit_timeout_impact_command,
    audit_trade_duration_command,
    audit_class_separability_command,
    audit_edge_baseline_command,
    audit_effective_runtime_config_command,
    audit_edge_hypotheses_command,
    audit_horizon_exits_command,
    audit_label_noise_command,
    audit_regime_features_command,
    audit_regime_value_command,
    audit_symbol_context_runtime_command,
    audit_strategy_block_causes_command,
    audit_symbol_signal_command,
    build_symbol_profiles_command,
    compare_h12_exit_variants_command,
    compare_exit_alignment_command,
    compare_experiment_results_runtime_command,
    compare_regime_experiments_command,
    compare_symbol_models_command,
    compare_symbol_variants_command,
    evaluate_demo_execution_candidate_command,
    evaluate_gbpusd_demo_candidate_command,
    evaluate_label_horizon_candidate_command,
    evaluate_regime_demo_candidate_command,
    evaluate_dynamic_exits_command,
    fetch_extended_history_command,
    run_h12_exit_realignment_command,
    run_label_horizon_realignment_command,
    run_experiment_command,
    run_experiment_matrix_command,
    run_regime_aware_rework_command,
    run_structural_rework_evaluation_command,
    run_strategy_validation_command,
    run_symbol_research_command,
    run_symbol_structural_rework_command,
...
def build_command_handlers() -> dict[str, CommandHandler | None]:
    return {
        ...
        "run-experiment-matrix": run_experiment_matrix_command,
        "run-structural-rework-evaluation": run_structural_rework_evaluation_command,
        "run-symbol-structural-rework": run_symbol_structural_rework_command,
        "fetch-extended-history": fetch_extended_history_command,
        "audit-regime-features": audit_regime_features_command,
        "run-regime-aware-rework": run_regime_aware_rework_command,
        "compare-regime-experiments": compare_regime_experiments_command,
        "evaluate-demo-candidate": evaluate_regime_demo_candidate_command,
        "audit-edge-baseline": audit_edge_baseline_command,
        "audit-label-noise": audit_label_noise_command,
        "audit-horizon-exits": audit_horizon_exits_command,
        "audit-regime-value": audit_regime_value_command,
        "audit-class-separability": audit_class_separability_command,
        "audit-edge-hypotheses": audit_edge_hypotheses_command,
        "audit-trade-duration": audit_trade_duration_command,
        "audit-timeout-impact": audit_timeout_impact_command,
        "run-label-horizon-realignment": run_label_horizon_realignment_command,
        "compare-exit-alignment": compare_exit_alignment_command,
        "evaluate-label-horizon-candidate": evaluate_label_horizon_candidate_command,
        "audit-exit-lifecycle": audit_exit_lifecycle_command,
        "run-h12-exit-realignment": run_h12_exit_realignment_command,
        "compare-h12-exit-variants": compare_h12_exit_variants_command,
        "evaluate-gbpusd-demo-candidate": evaluate_gbpusd_demo_candidate_command,
        "audit-symbol-signal": audit_symbol_signal_command,
        "compare-symbol-variants": compare_symbol_variants_command,
        "evaluate-demo-execution-candidate": evaluate_demo_execution_candidate_command,
        "audit-effective-config": audit_effective_runtime_config_command,
        "audit-symbol-context": audit_symbol_context_runtime_command,
        "compare-experiment-results": compare_experiment_results_runtime_command,
        "run-backtest": None,
        "backtest": None,
        ...
        "validate-model-artifact": validate_model_artifact_runtime_command,
        "activate-demo-execution": activate_demo_execution_runtime_command,
        "start-demo-forward-series": start_demo_forward_series_runtime_command,
        "demo-execution-preflight": demo_execution_preflight_runtime_command,
        "run-demo-execution": run_demo_execution_runtime_command,
        "demo-execution-status": demo_execution_status_runtime_command,
        "demo-forward-series-status": demo_forward_series_status_runtime_command,
        "close-demo-forward-series": close_demo_forward_series_runtime_command,
        ...
        "ingest-governance-evidence": ingest_governance_evidence_command,
        ...
        "restore-safety-drill": restore_safety_drill_command,
        "reconciliation-drills": reconciliation_drills_command,
        "recovery-drills": recovery_drills_command,
        "run-demo-guarded-soak": run_demo_guarded_soak_command,
        "demo-operational-readiness": demo_operational_readiness_command,
        "serious-demo-control-gate": serious_demo_control_gate_command,
        "prolonged-serious-demo-gate": prolonged_serious_demo_gate_command,
        "demo-serious-validated": demo_serious_validated_gate_command,
        "demo-forward-runbook": demo_forward_runbook_runtime_command,
    }
