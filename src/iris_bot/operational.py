...
def write_operational_artifacts(
    ...
    write_json(run_dir / "open_positions_snapshot.json", artifacts.state.to_dict())
    write_json(run_dir / "daily_summary.json", artifacts.daily_summary)
    write_json(run_dir / "reconciliation_report.json", artifacts.reconciliation_report)
    write_json(run_dir / "reconciliation_scope_report.json", artifacts.reconciliation_scope_report)
    write_json(run_dir / "restore_state_report.json", artifacts.restore_state_report)
    write_json(run_dir / "idempotency_report.json", artifacts.idempotency_report)
    write_json(run_dir / "operational_status.json", artifacts.operational_status)
    write_json(run_dir / "run_report.json", artifacts.run_report)
    write_json(run_dir / "validation_report.json", artifacts.validation_report)
